    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for(var i=0;i<data.length;i++ ){
                ...
                // Push header values to image array
                images.push(
                    {"Source":"img/header/"+data[i]["IMAGE"],"Title":data[i]["TITLE"],"Text":data[i]["SUB_TITLE"],"Button_text":data[i]["BUTTON_TEXT"],"Link":data[i]["LINK"]+"/"}
                );

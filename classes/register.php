    ...
    class Register {
        ...
        function verify_user($mail, $code) {
            ...
            if(!$this->validator->validate_mail($mail)) {
                ...
                echo "Thanks! You can now proceed to sign in.";
        ...
        function change_mail($username, $password, $mail) {
            ...
            if(!$this->validator->validate_username($username)) {
                ...
                $body = "To complete your email change on rajohan.no please confirm your email address by typing in the verification code underneath on the verification page or click on this link https://rajohan.no/verify/?email=".$mail."&code=".$code[1]."<br><br>Your verification code: ".$code[1]."<br><br>The email change was made from IP ".$this->ip.".";

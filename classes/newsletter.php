        ...
        function unsubscribe_code($mail) {
            ...
            if($validator->validate_mail($mail)) {
                ...
                if($this->check_email($mail) < 1) {
                    ...
                    $body = "A request to unsubscribe from rajohan.no's newsletters was made from IP ".$ip.".<br><br>To confirm your unsubscribtion please type in the verification code
                    underneath on the page you requested the unsubscription on or click on this link https://rajohan.no/unsubscribe/?email=".$mail."&code=".$code."
                    <br><br>Your verification code: ".$code."<br><br>If this unsubscription was not requested by you this email can be ignored.";
                    
                    $alt_body = "A request to unsubscribe from rajohan.no's newsletters was made from IP ".$ip.".\r\n\r\nTo confirm your unsubscribtion please type in the verification code
                    underneath on the page you requested the unsubscription on or click on this link https://rajohan.no/unsubscribe/?email=".$mail."&code=".$code."

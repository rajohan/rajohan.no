        ...
        <div class="text-editor u-margin-top-small">
            <div class="text-editor__toolbox u-margin-top-small">
                ...
                <div id="toolbox__emoticons__box" class="text-editor__toolbox__emoticons__box">
                    ...
                    <img src="img/icons/emoticons/smile.svg" alt="bold" id="emoticon__smile" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ':)');">
                    <img src="img/icons/emoticons/wink.svg" alt="wink" id="emoticon__wink" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ';)');">
                    <img src="img/icons/emoticons/tongue.svg" alt="tongue" id="emoticon__tongue" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ':p');">
                    <img src="img/icons/emoticons/grin.svg" alt="grin" id="emoticon__grin" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ':D');">
                    <img src="img/icons/emoticons/laugh.svg" alt="laugh" id="emoticon__laugh" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', '^^');">
                    <img src="img/icons/emoticons/frowny.svg" alt="frowny" id="emoticon__frowny" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ':(');">
                    <img src="img/icons/emoticons/unsure.svg" alt="unsure" id="emoticon__unsure" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ':/');">
                    <img src="img/icons/emoticons/cry.svg" alt="cry" id="emoticon__cry" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ':\'(');">
                    <img src="img/icons/emoticons/grumpy.svg" alt="grumpy" id="emoticon__grumpy" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', '>:(');">
                    <img src="img/icons/emoticons/angry.svg" alt="angry" id="emoticon__angry" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ':@');">
                    <img src="img/icons/emoticons/astonished.svg" alt="astonished" id="emoticon__astonished" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ':o');">
                    <img src="img/icons/emoticons/afraid.svg" alt="afraid" id="emoticon__afraid" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ':O');">
                    <img src="img/icons/emoticons/nerd.svg" alt="nerd" id="emoticon__nerd" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', '8-)');">
                    <img src="img/icons/emoticons/dejected.svg" alt="dejected" id="emoticon__dejected" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', '-_-');">
                    <img src="img/icons/emoticons/big_eyes.svg" alt="big_eyes" id="emoticon__big_eyes" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ':|');">
                    <img src="img/icons/emoticons/sunglasses.svg" alt="sunglasses" id="emoticon__sunglasses" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', '8)');">
                    <img src="img/icons/emoticons/confused.svg" alt="confused" id="emoticon__confused" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ':s');">
                    <img src="img/icons/emoticons/silent.svg" alt="silent" id="emoticon__silent" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ':x');">
                    <img src="img/icons/emoticons/love.svg" alt="love" id="emoticon__love" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', '<3');">
                    <img src="img/icons/emoticons/kiss.svg" alt="kiss" id="emoticon__kiss" class="text-editor__emoticons__icon" onClick="execCmd('insertEmoticon', ':*');">
                </div>
                <div class="text-editor__toolbox__separator"></div>

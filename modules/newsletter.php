...
<div class="newsletter__container u-margin-bottom-medium">
    <div class="newsletter__box">
        ...
        <form action="newsletter/" method="post" class="newsletter__form u-margin-top-small">
            <input type="text" name="newsletter" class="newsletter__form__input" placeholder="Your email address...">
            <button class="newsletter__form__button">
                <img class="newsletter__form__icon" src="img/icons/arrow_right.svg" alt="search">
            </button>
        </form>
